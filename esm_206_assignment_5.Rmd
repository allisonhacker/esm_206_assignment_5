...
ggplot(channel_weight, aes(x = weight)) +
  ...
  facet_wrap(~unittype,
             nrow = 3,
             labeller = labeller(unittype = channel_labels)) + 
  scale_color_manual(values = c("mediumturquoise", "lightseagreen", "seagreen4")) +
  scale_fill_manual(values = c("mediumturquoise", "lightseagreen", "seagreen4")) +
  theme_minimal() + 
  theme(panel.grid.minor = element_blank()) +
  labs(x = "Weight (g)",
       y = "Density")
...
ggplot(channel_weight, aes(y = weight,
                           x = unittype)) +
  geom_jitter(aes(color = unittype),
              alpha = 0.6,
               show.legend = FALSE,
              width = 0.1) +
  geom_violin(aes(color = unittype,
               ...
               alpha = 0.5,
               show.legend = FALSE) +
  scale_color_manual(values = c("darkslategray4", "steelblue4", "royalblue3")) +
  scale_fill_manual(values = c("darkslategray4", "steelblue4", "royalblue3")) +
  theme_minimal() + 
  theme(panel.grid.minor = element_blank()) +
  labs(y = "Weight (g)",
